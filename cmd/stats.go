...
var statsCmd = &cobra.Command{
	Use:   "stats",
	Short: "Stats gives us info about one or all our habits",
	Long: `To see current(running) streak and max streak for all habits:
  streakr stats

To see habit wise monthly heatmap:
  streak stats <habitname>`,
